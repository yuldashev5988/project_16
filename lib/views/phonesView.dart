      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: Text(
              "Watches",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),
            ),
            centerTitle: true,
          ),
          SliverGrid(
            delegate: SliverChildBuilderDelegate(
                ...
                return Container(
                  ...
                  color: Colors.white,
                  child: _watches(imagePath: "assets/images/phones.png", text:"Phone Name with \n#Samsung", price: 1099.99, realPrice: 1299.99, discount: 12, rating: 4.9, views: 120.2),
                );
              },
              childCount: 4,
            ),
