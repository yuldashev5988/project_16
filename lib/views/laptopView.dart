      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: Text(
              "Laptop and Notebooks",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),
            ),
            centerTitle: true,
          ),
          SliverGrid(
            delegate: SliverChildBuilderDelegate(
                ...
                return Container(
                  ...
                  color: Colors.white,
                  child: _men(imagePath: "assets/images/laptop.png", text:"Brand name is \n#Asusi", price: 1799.99, realPrice: 2009.99, discount: 27, rating: 4.9, views: 90.2),
                );
              },
              childCount: 100,
            ),
